    ...
    <div className="mt-1 h-[1.0625rem]">
      {feedback === "updated" ? (
        ...
        <button
          type="button"
          onClick={onMarkDone}
          className="inline-flex cursor-pointer items-center gap-1 border-0 bg-transparent p-0 text-sm font-light tracking-[-0.01em] text-white/35 transition-colors duration-200 ease-[cubic-bezier(0.25,0.1,0.25,1)] hover:text-white/45"
        >
